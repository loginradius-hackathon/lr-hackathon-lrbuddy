...
manager.addAnswer("en", "agent.forgotpassword", `var forgotpassword_options = {};
...
manager.addAnswer("en", "agent.resetpassword", `var resetpassword_options = {};
...
manager.addAnswer("en", "agent.verifyemail", `var verifyemail_options = {};
